  ...
  return (
    <div className="min-h-screen flex flex-col">
      <nav className="px-6 py-4 border-b-2 border-ink flex items-center justify-between">
        ...
        <Link href="/auth/signup" className="text-xs font-bold uppercase tracking-widest hover:underline">
          No account? Sign up →
        </Link>
      </nav>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="flex flex-col gap-4">
            ...
            <button onClick={handleLogin} disabled={loading} className="btn btn-primary w-full mt-2">
