    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-16 bg-paper">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col gap-4">
          <div>
            <label className="text-xs font-bold uppercase tracking-widest block mb-1.5">Workspace Name</label>
            <input
              type="text"
              value={workspaceName}
          ...
          <button onClick={createWorkspace} disabled={loading} className="btn btn-primary w-full mt-2">
