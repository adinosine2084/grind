    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        <nav className="px-6 py-4 border-b-2 border-ink flex items-center justify-between">
          ...
          <Link href="/auth/login" className="text-xs font-bold uppercase tracking-widest hover:underline text-ink">
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-16">
          <div className="w-full max-w-sm">
            ...
            <p className="text-xs text-[#aaa] mt-5 leading-relaxed">
              ...
              <a href="#" className="underline text-[#aaa]">Terms</a> and{' '}
              <a href="#" className="underline text-[#aaa]">Privacy Policy</a>.
            </p>
          </div>
        </div>
      </div>
